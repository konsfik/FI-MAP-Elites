...
{
    public class EM__Percent_Isolated_Vertices : Evaluation_Method<DS__Undirected_Graph>
    {
        public override object Q__Deep_Copy()
        {
            return new EM__Percent_Isolated_Vertices();
        }
        ...
        public override double Evaluate_Individual(DS__Undirected_Graph undirected_graph)
        {
            ...
            else
            {
                ...
                {
                    if (undirected_graph.Q__Is_Isolated(v))
                        num_isolated_verts++;
                }
                return (double)num_isolated_verts / (double)num_verts;
            }
        }
    }
}
