...
{
    public class CEM__L3__Not_Narrow_Passages : Constraint_Evaluation_Method<DS__Architectural_Plan>
    {
        public double min_bridge_line_magnitude;

        public CEM__L3__Not_Narrow_Passages(double min_bridge_line_magnitude)
        {
            this.min_bridge_line_magnitude = min_bridge_line_magnitude;
        }

        private CEM__L3__Not_Narrow_Passages(CEM__L3__Not_Narrow_Passages cem_to_copy)
        {
        ...
        {
            return new CEM__L3__Not_Narrow_Passages(this);
        }
        ...
        public override bool Q__Satisfied(DS__Architectural_Plan individual)
        {
            ...
            foreach (var edge in bridge_edges) {
                ...
                if (bridge_line_length < min_bridge_line_magnitude) return false;
            }
