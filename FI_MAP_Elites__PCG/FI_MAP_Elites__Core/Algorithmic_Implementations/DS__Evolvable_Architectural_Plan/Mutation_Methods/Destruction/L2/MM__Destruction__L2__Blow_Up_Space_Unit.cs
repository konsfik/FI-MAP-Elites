...
{
    public class MM__Destruction__L2__Blow_Up_Space_Unit<T> : Mutation_Method<T>
        where T : DS__Evolvable_Geometry
    {
        public readonly bool recalculate_phenotype;

        public MM__Destruction__L2__Blow_Up_Space_Unit(
        ...
        private MM__Destruction__L2__Blow_Up_Space_Unit(
            MM__Destruction__L2__Blow_Up_Space_Unit<T> mm_to_copy
            )
        {
        ...
        {
            return new MM__Destruction__L2__Blow_Up_Space_Unit<T>(this);
        }
        ...
        public override void Mutate_Individual(I_PRNG rand, T individual)
        {
            ...
            List<int> surrounding_cells =
                individual.Q__Space_Unit__Surrounding_Cells(
                    selected_space_unit
                    );

            // assign all the surrounding cells to that space unit
