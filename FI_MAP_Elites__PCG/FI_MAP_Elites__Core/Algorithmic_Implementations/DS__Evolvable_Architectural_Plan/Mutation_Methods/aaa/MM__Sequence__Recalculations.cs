...
{
    public class MM__Sequence__Recalculations : Mutation_Method<DS__Architectural_Plan>
    {
        ...
        public MM__Sequence__Recalculations(
        ...
        private MM__Sequence__Recalculations(
            MM__Sequence__Recalculations mm_to_copy
            )
        {
        ...
        {
            return new MM__Sequence__Recalculations(this);
        }
