...
namespace FI_MAP_Elites__Experiments
{
    public static partial class Templates__PCG_Workshop
    {
        ...
        public static Mutation_Method<DS__Architectural_Plan> Template__Mutation_Method__Ortho_Hex_Grid(
            ...
            MM__Sequence__Recalculations mutation_method =
                new MM__Sequence__Recalculations(
                    new List<Mutation_Method<DS__Architectural_Plan>>() {
                        Template__MM__Destruction__Ortho_Hex(1,3),
        ...
        private static Mutation_Method<DS__Architectural_Plan> Template__MM__Destruction__Ortho_Hex(
        ...
        public static Mutation_Method<DS__Architectural_Plan> Template__Mutation_Method__Free_Style(
            double area_error_margin
            )
        {
            MM__Sequence__Recalculations mutation_method =
                new MM__Sequence__Recalculations(
                    new List<Mutation_Method<DS__Architectural_Plan>>() {
                        Template__MM__Destruction__Free_Style(1,3),
                        Template__MM__Repair(area_error_margin)
                    },
                    recalculate_phenotype: false,
                    starting_level: 1
        ...
        private static Mutation_Method<DS__Architectural_Plan> Template__MM__Destruction__Free_Style(
            int minimum_selections,
            int maximum_selections
            )
        {
